      ...
      <div class="m-auto relative p-4 w-1/2 h-full md:h-auto">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div class="p-6 space-y-6 w-full">
            <div class="w-full">
              <LineChart v-if="data.data[0].ticker != 'none'" :symbol="symbol"></LineChart>
              <!--nciht sofort laden -->
            ...
            <div class="w-full flex-row columns-2">
              ...
              <table class="text-grey">
                <tbody>
                  <tr>
                    <td>24h Change:</td>
                    <td class="pl-5" :class="{ 'text-red-500': data.data[0]['day_change'] < 0 }">
  ...
  methods: {
    async modalHandler(val) {
      ...
      const result = await axios.get(
        `https://api.stockdata.org/v1/data/quote?symbols=${this.symbol}&api_token=eJLUoUVC234SV2oMXYJYNj8SWxehg0B8HNJj41uD`,
      );
