<template>
  <div class="mb-32">
    <br />
    <h1 class="text-4xl font-bold leading-normal text-blue-600 text-center">Trending today</h1>
    <div class="flex flex-wrap items-center justify-center gap-7 py-20 sm:px-6 px-4">
      <div class="w-64 p-4 rounded border hover:shadow-lg bg-blue-600">
        ...
        <div class="flex items-center justify-between mt-8">
          <h1 class="text-2xl font-semibold leading-normal text-white">{{ aapl.price }} $</h1>
          <p
            :class="{
      ...
      <div class="w-64 p-4 rounded border hover:shadow-lg bg-blue-600">
        ...
        <div class="flex items-center justify-between mt-8">
          <h1 class="text-2xl font-semibold leading-normal text-white">{{ msft.price }} $</h1>
          <p
            :class="{
      ...
      <div class="w-64 p-4 rounded border hover:shadow-lg bg-blue-600">
        <div class="flex justify-center items-center flex-col">
          <div class="flex justify-center items-center flex-col mt-3">
            <div class="image">
              <img class="my-auto" src="https://logo.clearbit.com/google.com?size=80" />
            </div>
        ...
        <div class="flex items-center justify-between mt-8">
          <h1 class="text-2xl font-semibold leading-normal text-white">{{ googl.price }} $</h1>
          <p
            :class="{
